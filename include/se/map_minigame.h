...
typedef struct SEMap_MiniGame__vtable SEMap_MiniGame__vtable;
struct SEMap_MiniGame__vtable {
...
typedef struct SEMap_MiniGame SEMap_MiniGame;
struct SEMap_MiniGame {
    ...
    int m_StoredGems;
    int m_GemsCollected;
    /* MiniGame_Waves* */ void* m_pMiniGameWaves;
